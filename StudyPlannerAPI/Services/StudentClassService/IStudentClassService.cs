...
namespace StudyPlannerAPI.Services.StudentClassService
{
    ...
    {
        Task<ServiceResponse<PagedResponse<StudentClassResponseDTO>>> GetStudentClassListAsync(string classId,int page, int pageSize);
        Task<ServiceResponse<PagedResponse<StudentClassResponseDTO>>> SearchStudentClassListAsync(string classId,string textToSearch, int page, int pageSize);
